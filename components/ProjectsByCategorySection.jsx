...
import { getDataByCategory, getFeaturedData } from '../utils/apiFunctions'
import Link from 'next/link'
import Image from 'next/image'

const ProjectsByCategorySection = ({title,category}) => {
  const [projects, setProjects] = useState([])

  useEffect(() => {
      
    getDataByCategory(category,'projects').then((val)=>{
      setProjects(val)
    })
}, )
  return (
...
export default ProjectsByCategorySection